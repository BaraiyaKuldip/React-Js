...
export default class DinningTable extends React.Component {
    ...
    shouldComponentUpdate(nextProperty, nextState) {
        ...
        if (this.state.roti !== nextState.roti || this.state.papad !== nextState.papad || this.state.chas !== nextState.chas || this.state.ras !==nextState.ras || (this.state.thali !== nextState.thali && this.state.thali <4))
        {
    ...
    componentDidUpdate(previousProperty, previousState) {
        ...
        if ( (this.state.thali !== previousState.thali && this.state.thali <=4))
            {
